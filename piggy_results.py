...
#Read data
my_data_piggy = pd.read_table('IGR_presence_absence.Rtab.txt',
                     sep='\t',
                     low_memory=False)

my_data_roary = pd.read_table('gene_presence_absence.Rtab.txt',
                     sep='\t',
                     low_memory=False)
